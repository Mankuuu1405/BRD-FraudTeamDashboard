...
export default function TeamManagement() {
    ...
    if (loading) return <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm animate-pulse">Loading team...</div>;
                ...
                <table className="w-full text-sm text-left">
                    <thead className="bg-gray-50 text-gray-600 font-semibold uppercase tracking-wider text-[11px]">
                        <tr>
                            ...
                            <th className="px-6 py-4">Groups / Teams</th>
                            ...
                            <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <span className="text-green-700 font-bold text-xs uppercase tracking-tight">Active</span>
                                    </div>
                                </td>
                            </tr>
                        ))}
